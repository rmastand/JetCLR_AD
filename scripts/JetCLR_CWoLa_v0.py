...
fig = plt.figure(figsize = (10,8))
plt.errorbar(f1_vals, avg_full_sup_results_dict["AUC"][layer][0], yerr = avg_full_sup_results_dict["AUC"][layer][1], label = "Fully Supervised", capsize = capsize, fmt = "o", xerr = xerr, color = "black")
plt.errorbar(f1_vals, avg_cwola_results_dict["AUC"][layer][0], yerr = avg_cwola_results_dict["AUC"][layer][1], label = "CWoLa", capsize = capsize, fmt = "^", xerr = xerr, color = layer_colors[layer])
plt.legend()
plt.ylim(0.45, 1)
plt.xlabel("$f_1$")
plt.ylabel("AUC")
...
fig = plt.figure(figsize = (10,8))
plt.errorbar(f1_vals, avg_full_sup_results_dict["maxsic"][layer][0], yerr = avg_full_sup_results_dict["maxsic"][layer][1], label = "Fully Supervised", capsize = capsize, fmt = "o", xerr = xerr, color = "black")

plt.errorbar(f1_vals, avg_cwola_results_dict["maxsic"][layer][0], yerr = avg_cwola_results_dict["maxsic"][layer][1], label = "CWoLa", capsize = capsize, fmt = "^", xerr = xerr, color = layer_colors[layer])
plt.legend()
plt.xlabel("$f_1$")
plt.ylim(0.9, 3)
plt.ylabel("maxSIC")
...
fig = plt.figure(figsize = (10,8))
plt.errorbar(f1_vals, avg_full_sup_results_dict["FPRatTPR"][layer][0], yerr = avg_full_sup_results_dict["FPRatTPR"][layer][1], label = "Fully Supervised", capsize = capsize, fmt = "o", xerr = xerr, color = "black")

plt.errorbar(f1_vals, avg_cwola_results_dict["FPRatTPR"][layer][0], yerr = avg_cwola_results_dict["FPRatTPR"][layer][1], label = "CWoLa", capsize = capsize, fmt = "^", xerr = xerr, color = layer_colors[layer])
plt.legend()
plt.xlabel("$f_1$")
plt.ylabel("FPR @ TPR = 0.5")
plt.ylim(0.1, 0.8)
